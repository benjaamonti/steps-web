        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp/10 text-whatsapp transition-colors duration-200 group-hover:bg-whatsapp group-hover:text-white">
