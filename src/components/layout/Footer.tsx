      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              {siteConfig.social.instagram && (
                <li className="flex items-center space-x-3">
                  <Instagram className="w-5 h-5 text-[#d65661] flex-shrink-0" />
                  <a
              ...
              {siteConfig.social.facebook && (
                <li className="flex items-center space-x-3">
                  <Facebook className="w-5 h-5 text-[#d65661] flex-shrink-0" />
                  <a
              ...
              {siteConfig.social.whatsapp && (
                <li className="flex items-center space-x-3">
                  <svg
                    className="w-5 h-5 text-[#d65661] flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 24 24"
        ...
        <div className="border-t border-white/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <Link
              to="/privacidad"
              className="text-white/60 hover:text-[#d65661] transition-colors duration-200 text-sm"
            >
